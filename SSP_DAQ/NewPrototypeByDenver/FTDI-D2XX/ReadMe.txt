...
libftd2xx uses an unmodified version of libusbx (http://libusbx.org) which
...
libusbx is included in this distribution.
...
1.  tar xfvz libftd2xx1.2.7.tar.gz
...
5.  chmod 0755 /usr/local/lib/libftd2xx.so.1.2.7

Allows non-root access to the shared object.

6.  ln -sf /usr/local/lib/libftd2xx.so.1.2.7 /usr/local/lib/libftd2xx.so

Creates a symbolic link to the 1.2.7 version of the shared object.
